...
def adjust_paths(html_content, is_subdirectory):
    ...
    html_content = html_content.replace('href="styles-muslimpro.css"', 'href="../styles-muslimpro.css"')
...
about_us_content = """
    ...
    <section class="hero-section">
        ...
        <p>Your trusted Islamic companion, empowering Muslims worldwide with accurate prayer times, comprehensive Quran resources, and meaningful Islamic content to strengthen your connection with Allah.</p>
    </section>
